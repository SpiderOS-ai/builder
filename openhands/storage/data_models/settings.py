...
def _get_default_v1_enabled() -> bool:
    """Get the default value for v1_enabled from environment variable.

    Returns True unless DEFAULT_V1_ENABLED is explicitly set to '0' or 'false'.
    """
    value = os.getenv("DEFAULT_V1_ENABLED", "true").lower()
...
class Settings(BaseModel):
    ...
    v1_enabled: bool = Field(default_factory=_get_default_v1_enabled)
